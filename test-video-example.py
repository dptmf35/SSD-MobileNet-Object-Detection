...
import cv2
cap = cv2.VideoCapture('./test_video/02.mp4')
...
PATH_TO_CKPT = './station_inference_graph/frozen_inference_graph.pb'
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    while True:
      ...
      image_np = cv2.resize(image_np, (320,240), interpolation=cv2.INTER_LINEAR)
